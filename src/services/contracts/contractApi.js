...
const contractApi = {
  ...
  getById(id) {
    ...
    return api.get(`/contracts/${encodedId}`).then((res) => res.data);
  },

  /** Obtener contratos asociados a una propiedad */
  getByProperty(propertyId) {
    const encodedId = encodeURIComponent(propertyId);
    return api.get(`/contracts/property/${encodedId}`).then((res) => res.data);
  },
  ...
  update(id, payload) {
    const encodedId = encodeURIComponent(id);
    return api.put(`/contracts/${encodedId}`, payload).then((res) => res.data);
  },
  ...
  updateStatus(id, status) {
    const encodedId = encodeURIComponent(id);
    return api.patch(`/contracts/${encodedId}/status`, { status }).then((res) => res.data);
  },
  ...
  sign(id, payload) {
    const encodedId = encodeURIComponent(id);
    return api.post(`/contracts/${encodedId}/sign`, payload).then((res) => res.data);
  },
  ...
  getSignatures(id) {
    const encodedId = encodeURIComponent(id);
    return api.get(`/contracts/${encodedId}/signatures`).then((res) => res.data);
  },

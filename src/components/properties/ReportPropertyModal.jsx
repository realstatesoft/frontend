  ...
  return (
    <Modal show={isOpen} onHide={handleClose} centered>
      <Modal.Header closeButton>
        <Modal.Title>Reportar propiedad</Modal.Title>
      </Modal.Header>
        ...
        {success ? (
          <div>
            <p className="text-success fw-bold mb-0">
              Tu reporte fue enviado. Gracias por contribuir a la seguridad de la plataforma.
            </p>
          </div>
        ) : (
          <Form onSubmit={handleSubmit}>
            <p className="mb-4 text-muted">
              Si considerás que esta propiedad es fraudulenta, ilegal o sospechosa, completá el formulario. 
            ...
            <Form.Group className="mb-3">
              ...
              >
                ...
                <option value="SPAM">Spam o contenido duplicado</option>
              </Form.Select>
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control 
                ...
                rows={4}
                maxLength={1000}
                placeholder="Describí con detalle por qué estás reportando esta propiedad..."
                value={reason}

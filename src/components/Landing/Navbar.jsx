    ...
    <Navbar expand="lg" className="bg-light py-3">
      <Container className="bg-white rounded-pill shadow-sm px-4 py-2">
        ...
        <div className="profile-dropdown-wrapper" ref={dropdownRef}>
          ...
          >
            {/* Muestra foto de perfil si el usuario esta logueado y tiene imagen, o avatar generico */}
            ...
            <div className="profile-dropdown-menu">
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link to="/ajustes" className="profile-dropdown-item" onClick={() => setDropdownOpen(false)}>

                ...
                <Row className="g-4 mb-5">
                    ...
                    <Col lg={2} xs={6}>
                        ...
                        <ul className="list-unstyled" style={{ fontSize: "0.9rem" }}>
                            <li className="mb-2"><a href="#" style={{ textDecoration: "none", color: "#827d7dff" }}>Sobre nosotros</a></li>
                            <li className="mb-2"><a href="#" style={{ textDecoration: "none", color: "#827d7dff" }}>Servicios</a></li>
                            <li className="mb-2"><a href="#" style={{ textDecoration: "none", color: "#827d7dff" }}>Agentes</a></li>
                        </ul>
                    </Col>
                    <Col lg={2} xs={6}>
                        <h6 className="text-white fw-semibold mb-3">Propiedades</h6>
                        <ul className="list-unstyled" style={{ fontSize: "0.9rem" }}>
                            <li className="mb-2"><a href="#" style={{ textDecoration: "none", color: "#827d7dff" }}>Comprar</a></li>
                            <li className="mb-2"><a href="#" style={{ textDecoration: "none", color: "#827d7dff" }}>Alquilar</a></li>
                            <li className="mb-2"><a href="#" style={{ textDecoration: "none", color: "#827d7dff" }}>Vender</a></li>
                        </ul>
                    </Col>
                    <Col lg={4}>
